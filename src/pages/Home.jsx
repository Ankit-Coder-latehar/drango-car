...
const slidesData = [
  {
    image: "/hero_grave_arch.png",
    tagline: "BESPOKE MAHINDRA THAR EXTERIOR CLADDING",
    title: <>GRAVE ARCH™ <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500">CLADDING.</span></>,
    desc: "UV-Resistant ABS multi-piece fender claddings with detailed engraved floral texture and integrated LED side markers."
  },
  {
    image: "/hero_rear_corner_accents.jpg",
    tagline: "HAND-CRAFTED DETAIL FOR MAHINDRA THAR ROXX",
    title: <>REAR CORNER <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500">ACCENTS.</span></>,
    desc: "Elevate your style with Gold Carved and Black Mandala laser-etched corner accents with weather resistant finish."
  },
  {
    image: "/hero_black_filigree.png",
    tagline: "BESPOKE INTERIOR LUXURY FOR THAR ROXX",
    title: <>BLACK FILIGREE <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500">COLLECTION.</span></>,
    desc: "Transform your Thar Roxx interior with meticulously crafted matte-to-filigree accessories where precision engineering meets handcrafted detail."
  },
  {
    image: "Gemini_Generated_Image_vp6u0mvp6u0mvp6u.png",
    tagline: "BESPOKE INTERIOR LUXURY FOR THAR ROXX",
    title: <>BLACK FILIGREE <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500">COLLECTION.</span></>,
    desc: "Transform your Thar Roxx interior with meticulously crafted matte-to-filigree accessories where precision engineering meets handcrafted detail."
  },
...
const maharajaProducts = [
  {
    id: 'black-filigree',
    title: 'INTRODUCING BLACK FILIGREE COLLECTION',
    subtitle: 'A New Standard of Bespoke Interior Luxury for Mahindra Thar Roxx',
    badge: 'ROYAL INTERIOR EDITION',
    image: '/hero_black_filigree.png',
    tagline: 'Meticulously crafted matte-to-filigree accessories where precision engineering meets handcrafted detail.',
    features: [
      'Matte-to-filigree laser engraved AC vent surrounds & center console',
      'High-durability scratch resistant anodized filigree finish',
      'Custom bespoke interior luxury tailored specifically for Thar Roxx',
      '100% Direct OEM fitment with zero modification required'
    ]
  },
  {
    id: 'rear-corner-accents',
    title: 'REAR CORNER ACCENTS (GOLD & BLACK)',
    subtitle: 'Elevate Your Thar Roxx with Bespoke Royal Craftsmanship',
    badge: 'BESPOKE ROYAL ACCENTS',
    image: '/hero_rear_corner_accents.jpg',
    tagline: 'Available in Style A: Gold Carved & Style B: Black Mandala patterns with weather-resistant protection.',
    features: [
      'Style A: Gold Carved Royal Finish for iconic luxury presence',
      'Style B: Black Mandala Laser Etched Pattern for stealth regal look',
      'Weather resistant finish engineered for extreme off-road conditions',
      'A bespoke handcrafted touch for your vehicle'
    ]
  },
  {
    id: 'grave-arch',
    title: 'GRAVE ARCH™ WHEEL ARCH CLADDING',
    subtitle: 'Front & Rear Wheel Arch Cladding with Detailed Engraved Floral Texture',
    badge: 'EXTERIOR ARMOR & STYLE',
    image: '/hero_grave_arch.png',
    tagline: 'UV-resistant ABS cladding with integrated LED side markers and seamless fender guard integration.',
    features: [
      'Detailed engraved floral texture on UV-resistant ABS material',
      'Integrated amber LED side marker for safety & royal stance',
      'Multi-piece seamless fender guard integration',
      'Direct precision fitment engineered specifically for Mahindra Thar'
    ]
  },
  {
    id: 'filigree-console-kit',
    title: 'ROYAL FILIGREE STEERING & CONSOLE KIT',
    subtitle: 'Full Cockpit Filigree Luxury Upgrade',
    badge: 'LIMITED MAHARAJA COLLECTION',
    image: 'Gemini_Generated_Image_vp6u0mvp6u0mvp6u.png',
    tagline: 'Bespoke filigree luxury steering ring and dash emblem set for the ultimate interior ambiance.',
    features: [
      'Royal Crown insignia center ring detail',
      'Handcrafted mandala grip texture along steering & gear console',
      'Heat-resistant & UV-shielded interior alloy finish',
      'Exclusive limited edition production numbers'
    ]
  }
];

const MaharajaTharRoxxShowcase = () => {
  const [activeIdx, setActiveIdx] = useState(0);
  const activeProduct = maharajaProducts[activeIdx];

  return (
    <section className="py-20 md:py-28 bg-[#070709] border-b border-amber-950/40 relative overflow-hidden font-sans">
      {/* Royal Ambient Glows */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-500/20 via-yellow-500/10 to-amber-500/20 border border-amber-500/40 text-amber-400 font-mono text-xs uppercase tracking-widest shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            <CrownIcon size={14} className="text-amber-400 animate-pulse" />
            <span>MAHARAJA REGAL EDITION — MAHINDRA THAR ROXX</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-black uppercase text-white tracking-tight">
            BESPOKE ROYAL <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-600">DECORATION & ARTISTRY</span>
          </h2>
          <p className="text-zinc-400 text-sm md:text-base leading-relaxed">
            Experience Indian royal heritage meets precision automotive engineering. Explore our handcrafted filigree, mandala carved accents, and floral engraved arch armor for Mahindra Thar Roxx.
          </p>
        </div>

        {/* Product Switcher Tabs */}
        <div className="flex flex-wrap items-center justify-center gap-3">
          {maharajaProducts.map((prod, idx) => {
            const isActive = activeIdx === idx;
            return (
              <button
                key={prod.id}
                onClick={() => setActiveIdx(idx)}
                className={`px-5 py-3 rounded-xl font-bold text-xs md:text-sm uppercase tracking-wider transition-all duration-300 flex items-center gap-2 border ${
                  isActive
                    ? 'bg-gradient-to-r from-amber-500 to-yellow-600 text-black border-yellow-400 shadow-[0_0_20px_rgba(234,179,8,0.4)] scale-105'
                    : 'bg-zinc-900/80 hover:bg-zinc-800 text-zinc-300 border-zinc-800 hover:border-amber-500/50'
                }`}
              >
                <CrownIcon size={14} className={isActive ? 'text-black' : 'text-amber-500'} />
        ...
        <div className="bg-zinc-950/90 border border-amber-500/30 rounded-3xl p-6 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden backdrop-blur-md">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            {/* Left Side Product Graphic */}
            <div className="lg:col-span-7 relative group">
              <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl blur-xl" />
              <div className="relative aspect-[16/9] md:aspect-[16/10] bg-black rounded-2xl overflow-hidden border border-amber-500/20 shadow-2xl flex items-center justify-center">
                <img
                  src={activeProduct.image}
                  alt={activeProduct.title}
                  className="w-full h-full object-contain md:object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute top-4 left-4 bg-black/80 backdrop-blur-md border border-amber-500/40 text-amber-300 text-[10px] font-mono font-bold px-3 py-1.5 rounded-full uppercase tracking-wider">
                  👑 {activeProduct.badge}
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 space-y-6 text-left">
              <div>
                ...
                <p className="text-amber-200/80 text-xs font-semibold mt-1">
                  {activeProduct.subtitle}
                </p>
              </div>

              <p className="text-zinc-400 text-sm leading-relaxed border-l-2 border-amber-500/50 pl-4 py-1 italic">
              ...
              <div className="space-y-2.5 pt-2">
                {activeProduct.features.map((feat, fIdx) => (
                  <div key={fIdx} className="flex items-start gap-3 text-xs md:text-sm text-zinc-300">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <Link
                  to="/contact"
                  className="bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 hover:from-amber-400 hover:to-yellow-500 text-black font-black text-xs md:text-sm tracking-wider uppercase px-7 py-3.5 rounded-xl shadow-[0_0_20px_rgba(234,179,8,0.3)] transition-all duration-300 hover:scale-105 active:scale-95 flex items-center gap-2"
                >
                  <CrownIcon size={16} className="text-black" />
                  <span>Enquire Maharaja Fitment</span>
                </Link>
                <Link
                  to="/products"
                  className="bg-zinc-900 hover:bg-zinc-800 border border-amber-500/40 text-amber-300 font-bold text-xs md:text-sm tracking-wider uppercase px-6 py-3.5 rounded-xl transition-all duration-300 flex items-center gap-2"
                >
...
const BrothersBehindTheBrand = () => {
  return (
    <section className="py-20 md:py-28 bg-[#0b0b0c] border-b border-zinc-900 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 space-y-16">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="text-red-500 font-black tracking-widest text-xs uppercase font-mono block">
            MEET THE TEAM — THE VISIONARY FOUNDERS
          </span>
          <h2 className="text-3xl sm:text-5xl font-black uppercase text-white tracking-tight">
            THE BROTHERS BEHIND <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500 font-black">THE BRAND</span>
          </h2>
          <p className="text-zinc-400 text-sm md:text-base leading-relaxed">
            Founded by <strong>Sachin Choudhary</strong> and <strong>Lalit Choudhary</strong>, Drango turned a passion for automotive perfection into India’s most trusted detailing & Thar customization empire.
          </p>
        </div>

        {/* Two Founders Showcase Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {/* Founder 1: Sachin Choudhary */}
          <div className="bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 hover:border-red-600/50 rounded-3xl p-6 sm:p-8 transition-all duration-500 group shadow-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="space-y-6">
              {/* Image & Badge */}
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800 shadow-xl bg-black">
                <img
                  src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=800"
                  alt="Sachin Choudhary"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 brightness-95"
                />
                <div className="absolute top-4 left-4 bg-red-600 text-white font-mono text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-lg">
                  CO-FOUNDER & DETAILING STRATEGIST
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-red-400 font-mono text-xs font-bold uppercase tracking-widest">
                  8+ Years Master Paint Protection & Ceramic Coating Specialist
                </p>
                <p className="text-zinc-400 text-sm leading-relaxed pt-2">
                  Pioneered India’s high-precision 200-micron self-healing TPU PPF application processes. Sachin’s obsession with paint clarity and ceramic coatings laid the foundation for Drango’s nationwide repute.
                </p>
              </div>

              {/* Quote */}
              <div className="bg-zinc-950/80 border border-zinc-800/80 p-4 rounded-xl text-xs text-zinc-300 italic">
                "We set out to dismantle cheap polishing shortcuts in India by delivering true global paint protection standards to every car enthusiast."
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-mono text-zinc-400">
                ...
                <span className="font-bold text-white">2.3M+ Subscribers</span>
              </div>
          ...
          {/* Founder 2: Lalit Choudhary */}
          <div className="bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 hover:border-orange-500/50 rounded-3xl p-6 sm:p-8 transition-all duration-500 group shadow-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="space-y-6">
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800 shadow-xl bg-black">
                <img
                  ...
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 brightness-95"
                />
                <div className="absolute top-4 left-4 bg-orange-500 text-black font-mono text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-lg">
                  CO-FOUNDER & LEAD AUTOMOTIVE ENGINEER
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-orange-400 font-mono text-xs font-bold uppercase tracking-widest">
                  Mahindra Thar Roxx Bespoke Customization & Armor Specialist
                </p>
                <p className="text-zinc-400 text-sm leading-relaxed pt-2">
                  Head of custom body engineering and Maharaja royal decoration lines. Lalit leads the creation of bespoke filigree interior kits, off-road bumpers, and heavy-duty suspension upgrades.
                </p>
              </div>

              {/* Quote */}
              <div className="bg-zinc-950/80 border border-zinc-800/80 p-4 rounded-xl text-xs text-zinc-300 italic">
                "Whether it's a 4x4 Thar Roxx Maharaja transformation or a satin black Fortuner conversion, we build machines that make heads turn on every road."
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-mono text-zinc-400">
                <Youtube size={16} className="text-red-500" />
                <span className="font-bold text-white">450M+ Views</span>
              </div>
              <span className="text-xs font-bold text-orange-400 uppercase tracking-wider">
                15+ Pan-India Outlets
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="flex items-center gap-4 text-left">
            ...
            <div>
              <h4 className="text-lg md:text-xl font-black text-white uppercase">
                INDIA'S #1 AUTO DETAILING YOUTUBE CHANNEL
              </h4>
              <p className="text-zinc-400 text-xs md:text-sm">
                Watch Sachin & Lalit share live workshop detailing vlogs, Thar Roxx builds, and authentic PPF testing.
              </p>
            </div>
          </div>
          ...
          <a
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-bold text-xs md:text-sm tracking-wider uppercase px-7 py-3.5 rounded-xl transition-all duration-300 flex items-center gap-2 shrink-0 shadow-lg hover:shadow-red-600/30"
          >
            <Youtube size={18} />
...
const Home = () => {
  ...
  return (
    <div className="bg-[#0b0b0c] text-white font-sans">
      {/* Hero Section */}
      <section className="relative h-[65vh] sm:h-[75vh] md:h-[85vh] flex items-center justify-center overflow-hidden border-b border-zinc-900 group">
        <div className="absolute inset-0 z-0 overflow-hidden bg-black">
          <div
            className="flex h-full transition-transform duration-1000 ease-in-out"
            style={{
              width: `${slidesData.length * 100}%`,
              transform: `translate3d(-${currentSlide * (100 / slidesData.length)}%, 0, 0)`
            }}
          >
            {slidesData.map((slide, index) => (
              <div
                key={index}
                className="h-full relative shrink-0 bg-black flex items-center justify-center"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0c] via-transparent to-black/20 pointer-events-none"></div>
        </div>

        {/* Prev/Next Navigation Controls */}
        <button
          onClick={() => setCurrentSlide((prev) => (prev === 0 ? slidesData.length - 1 : prev - 1))}
          className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-black/60 hover:bg-red-600/80 text-white border border-white/20 flex items-center justify-center transition-all opacity-70 group-hover:opacity-100 backdrop-blur-sm"
          aria-label="Previous slide"
        >
          <ChevronLeft size={24} />
        </button>
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-black/60 hover:bg-red-600/80 text-white border border-white/20 flex items-center justify-center transition-all opacity-70 group-hover:opacity-100 backdrop-blur-sm"
          aria-label="Next slide"
        >
      ...
      {/* Maharaja Regal Edition Thar Roxx Decoration Showcase */}
      <MaharajaTharRoxxShowcase />

      {/* Stats Counter Section */}
      <section
        className="relative py-16 md:py-20 bg-cover bg-center bg-no-repeat border-b border-zinc-900 overflow-hidden"
        style={{ backgroundImage: `url('/Gemini_Generated_Image_j339inj339inj339.png')` }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center bg-zinc-950/50 border border-zinc-800/50 rounded-2xl p-6 backdrop-blur-md shadow-xl hover:border-red-500/40 transition-all duration-300">
                <p className="text-4xl md:text-5xl font-black text-white bg-gradient-to-r from-red-500 via-orange-400 to-amber-500 bg-clip-text text-transparent mb-2">
                  <AnimatedCounter value={stat.number} />
                </p>
                <p className="text-xs md:text-sm font-bold tracking-widest text-zinc-300 uppercase">
                  {stat.label}
                </p>
              </div>
            ))}
      ...
      {/* About the Founders Section (Meet the Team - Brothers Behind the Brand) */}
      <BrothersBehindTheBrand />

      {/* Bimbra-style Customize Vehicles Section (OUR PROCESS) */}
      <section
        className="py-20 text-zinc-900 border-b border-zinc-200 relative bg-cover bg-center bg-no-repeat overflow-hidden"
        style={{ backgroundImage: `url('Gemini_Generated_Image_j339inj339inj339.png')` }}
      >
      ...
      <section
        className="relative py-16 md:py-24 bg-cover bg-center bg-no-repeat border-y border-zinc-900 overflow-hidden font-sans w-full min-h-[650px]"
        style={{ backgroundImage: `url('/Gemini_Generated_Image_1r45nm1r45nm1r45.png')` }}
      >
        {/* Dark overlay for contrast & readability */}
        <div className="absolute inset-0 bg-black/85 backdrop-blur-[1px] -z-0"></div>
